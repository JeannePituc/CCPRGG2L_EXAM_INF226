import java.util.regex.Matcher;
		...
		public class Regex {
		    public static void main(String[] args) {
		        ...
		        // Provide the pattern
		        pattern = Pattern.compile(".[^pPtTcC]{5,}\\d$");
		        ...
		        // 3. The email prefix should contain the last two digits of your student
		        // number. This can appear anywhere in the prefix.

		        // 4. The length of the email prefix should be at least 10 characters if the
		        // last digit of your student number is an even number.

		        // 5. The length of the email prefix should be at least 15 characters if the
		        // last digit of your student number is an odd number.

		        // 6. The email prefix should not contain any special characters except the
		        ...
		        pattern = Pattern.compile("[\\w\\.29]{10,}@(gmail.com)$");
		        ...
		        // Provide regex pattern
		        pattern = Pattern.compile("[https?:\\/\\/]?[\\d\\w\\.\\-]+([\\/\\w\\W\\-)]?)");
		        ...
		        // Provide regex pattern
		        pattern = Pattern
		                .compile("\\w+(.pptx)|\\w+(\\.xlsx)|\\w+(.docx)|\\w+(.txt)");
		        ...
		        // Provide the regex pattern
		        tweet = tweet.replaceAll("(https?:\\/\\/)([a-z]+)\\.([a-z]{2})([\\/\\w]*)", "");
